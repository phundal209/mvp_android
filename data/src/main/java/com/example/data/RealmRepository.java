...
public class RealmRepository<T extends RealmObject> {
    ...
    public T create(final Class<? extends RealmObject> clazz, Object object){
        realm.beginTransaction();
        T realmObject = (T)realm.createObject(clazz, object);
        realm.commitTransaction();
    ...
    public RealmResults<?> getBy(Class<? extends RealmObject> clazz, String queryColumnName, String id) {
        return realm.where(clazz).equalTo(queryColumnName, id).findAll();
    }
    ...
    public T getFirstById(Class<? extends RealmObject> clazz, String idColumnName, String id) {
